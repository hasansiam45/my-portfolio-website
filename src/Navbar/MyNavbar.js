            ...
            <div className="container mb-3">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="ml-auto">
                        ...
                        <Nav.Link href="https://drive.google.com/uc?export=download&id=16lU6OjZoD96_bjQaJ4Ql4sYR3d1UTlqw" className="mx-3 p-3"><FontAwesomeIcon icon={faDownload} /> Resume</Nav.Link>
